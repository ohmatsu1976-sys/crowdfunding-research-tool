...
""")
    ...
    st.code("URL  調達額（任意）\nhttps://kickstarter.com/...  $1,234,567\nhttps://indiegogo.com/...  ¥185,000,000", language=None)
    st.caption("調達額はKickstarterページに表示されています。コピーしてURLの後ろに貼ってください。")
...
PLACEHOLDER = (
    ...
    "（URLの後ろに半角スペース＋調達額を書くと自動反映されます）"
)

st.markdown(
    "💡 **調達額の入力方法**: URLの後ろに半角スペース＋金額を入力してください。"
...
st.divider()
st.markdown(
    "<small>© クラファン物販スクール　本ツールはスクール受講生専用です</small>",
    unsafe_allow_html=True,
)
